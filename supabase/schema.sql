...
-- rappels), Fiche d'urgence, Liste d'envies, Bloc-notes — voir
-- supabase/migrations/007_espace_perso.sql
-- ---------------------------------------------------------------------------
...
-- partagés par cercle) — voir supabase/migrations/014_personnes.sql
-- ---------------------------------------------------------------------------
